...
def main():
    ...
    D = prep(args.window, main_ev, aux_ev, prior=prior, rings=args.rings, halo=args.halo,
             globpe=args.globpe, patch=args.patch, patch_side=args.patch_side, recenter=args.recenter, fold=args.fold, nfold=args.nfold, mmgeo=args.mmgeo, rc_regions=(set(args.rc_regions) if args.rc_regions else None), rc_mode=args.rc_mode, tcomb=args.tcomb, allcells=args.allcells,
