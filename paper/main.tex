...
and then improving the centre, cut the worst bin by $53\%$, while every architectural alternative measured
...
sum --- tracking the truncation tail above almost exactly. The window
plays both roles, and the measurements say where each one takes over.
